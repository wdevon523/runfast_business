...
public class WakeReceiver extends BroadcastReceiver {
    ...
    public static class WakeNotifyService extends Service {
        ...
        public void onCreate() {
            Log.i("devon", "WakeNotifyService->onCreate");
            super.onCreate();
        }

        @Override
        public int onStartCommand(Intent intent, int flags, int startId) {
            Log.i("devon", "WakeNotifyService->onStartCommand");
        ...
        public void onDestroy() {
            Log.i("devon", "WakeNotifyService->onDestroy");
            super.onDestroy();
        }
    }
    ...
    public static class WakeGrayInnerService extends Service {
        ...
        @Override
        public void onCreate() {
            Log.i("devon", "InnerService -> onCreate");
            super.onCreate();
        }

        @Override
        public int onStartCommand(Intent intent, int flags, int startId) {
            Log.i("devon", "InnerService -> onStartCommand");
            startForeground(WAKE_SERVICE_ID, new Notification());
            //stopForeground(true);
            stopSelf();
        ...
        @Override
        public void onDestroy() {
            Log.i("devon", "InnerService -> onDestroy");
            super.onDestroy();
        }
    }
}
